...
aws ecr get-login-password --region ap-northeast-2 | docker login --username AWS --password-stdin 894168368632.dkr.ecr.ap-northeast-2.amazonaws.com
...
docker tag {appname:tag} \
 {AWS_ACCOUNT_ID:894168368632}.dkr.ecr.ap-northeast-2.amazonaws.com/{repo}/{appname:tag}
docker tag file-management-app:1.0.0 894168368632.dkr.ecr.ap-northeast-2.amazonaws.com/dev/my-repo:file-management-app-1.0.0

# 이미지를 ECR로 푸시
docker push {AWS_ACCOUNT_ID}.dkr.ecr.ap-northeast-2.amazonaws.com/{repo}/{appname}
docker push 894168368632.dkr.ecr.ap-northeast-2.amazonaws.com/dev/my-repo:file-management-app-1.0.0
